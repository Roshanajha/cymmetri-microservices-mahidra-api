...
public class UnassignUserToGroupAudit extends AbstractAuditBuilder {
	 ...
	 */
	public static final String UNASSIGN_GROUP_USER = "UNASSIGN_GROUP_USER";

	/**
	 * "DESC_FAIL" qualifier.
	 */
	public static final String DESC_FAIL = "Group unassignment performed sucessfully for user.";

	/**
	 * "DESC_PASS" qualifier.
	 */
	public static final String DESC_PASS = "Group unassignment performed sucessfully for user.";

	public UnassignUserToGroupAudit() {
		super(UNASSIGN_GROUP_USER, SOURCE_TYPE, TARGET_TYPE);
	}
