...
package com.cymmetri.ms.user.auditaction.resetpassword;

import com.cymmetri.common.audit.AbstractAuditBuilder;
import com.cymmetri.common.audit.AuditLogResult;

public class AdminResetPasswordAudit extends AbstractAuditBuilder {
	 ...
	 * "DESC_FAIL" qualifier.
	 */
	public static final String DESC_FAIL = "failed to reset password.";

	/**
	 * "DESC_PASS" qualifier.
	 */
	public static final String DESC_PASS = "Password Reset successfully.";

	public AdminResetPasswordAudit() {
		super(ADMIN_RESET_PASSWORD, SOURCE_TYPE, TARGET_TYPE);
	}
